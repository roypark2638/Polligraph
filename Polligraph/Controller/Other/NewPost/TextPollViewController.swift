...
class TextPollViewController: UIViewController {
    ...
    private let descriptionLabel = NewPostTitleLabel(title: "Description")
    ...
    private func configureLayouts() {
        ...
        NSLayoutConstraint.activate([
            descriptionTextView.topAnchor.constraint(equalTo: descriptionLabel.bottomAnchor, constant: padding - 10),
            descriptionTextView.leadingAnchor.constraint(equalTo: descriptionLabel.leadingAnchor, constant: -4.6),
        ...
        pollsLabel.frame = CGRect(
            x: padding,
            y: max(descriptionTextView.bottom, descriptionLabel.bottom+50),
            width: 50,
            height: 20
        )
